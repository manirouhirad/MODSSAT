...
FN_optim2 = function(jj = 1) {
  ...
  quarter_1 <- quarter_1[, c("Well_capacity", "tot_acres", "quarter" = "1", "ifreq_1", "CR_1", "PAW_1", "mean_irrigation_combination", "mean_profit_combination", "mean_profit_combination_sub")]
  ...
  quarter_2 <- quarter_1[, c("Well_capacity", "tot_acres", "quarter" = "2", "ifreq_1", "CR_1", "PAW_1", "mean_irrigation_combination", "mean_profit_combination", "mean_profit_combination_sub")]
  colnames(quarter_1) <- c("Well_capacity", "tot_acres", "quarter", "ifreq", "CR", "PAW", "mean_irrigation_combination", "mean_profit_combination", "mean_profit_combination_sub")
