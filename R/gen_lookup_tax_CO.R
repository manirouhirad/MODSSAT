...
#' @param number_of_quarters             is the maximum nnumber of quarters that need to be considered in the lookup table generation.
                              ...
                              )
{
  ...
  for (i in 1:max(KS_DSSAT_2$group)) {
    ...
    well_capacity_data[ifreq < 2 & ifreq > 0, `:=`(ifreq, 2)]     # <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<< check this
